...
# Scope
This version of the book does not intend to solve all problems.

*\[I: INTRODUCTION\]*

# Chapter 1: The Operating System of Capitalism
...
~~ First we will give some signposts: to the questions studied in the book, to the fundamental theses of the book which are to be proven, disproven or so to speak 'limited', and to the structure of the rest of the book. ~~

## Research Questions: Five key challenges

The scope of this book is large. This is because the problems that it tries to solve are also large.  Its overarching purpose is to outline what constitutes a 'good' tax and welfare system. As mentioned in our introduction, this topic has already been explored by a number of economists. It will be our role therefore to review, synthesise, and build on their existing viewpoints. However we argue that the tax and welfare system has consequences outside of the immediate scope of tax and welfare itself, i.e. that there are consequences on a societal scale. We are also interested in exploring these wider outcomes of choices over tax and welfare system design.
...
-	Existing tax system
-	Importance of taxes easily calculable
-	Automatic tax system
Taxation Theory
-	Optimal Taxation
-	Externality Correcting
Attractiveness of proposals to politicians and voters
- Specific politician types
-	Specific policy pathways
Produce Beneficial Results
-	Reiterate challenges
Empirical evidence
-	Effect of incentives at work
-	Interaction between work, experience, education and salary
-	Effect of environmental taxes on damage
-	Effect of health taxes on health outcomes
-	Effect of taxes on finance
Political realities
-	Interest of voter groups
-	Folk justice
-	Interest of powerful groups
Institutional inertia
Local knowledge
-	Legal nature of tax system
-	Specific problems of UK system tax and economy (regional balances, dysfunctional house prices etc.)
Macroeconomic situation
-	Balance of payments, trade deficit
Feasibility of proposals
-	Have they being done elsewhere?
-	Any specific issues in the UK?
Robustness to changing times
...
# Chapter 16: Modelling the Proposals
