...
We sauy tax should be practical beneficial and fair. This corresponds to how much should be taxed, what should be taxed, and who should be taxed. Whereas the distinction between functional and non-functional corresponded to why we should tax versus how we should tax. The final question is where should we tax. This was dealt with in a separate slide discussing the geographical basis of tax.
...
2.	Changes to Income Tax to simplify it
3.	Introducing Wealth Taxes that can’t be avoided including
...
4.	Welfare Reforms such as a citizen’s dividend and an integrated skills development and educational work programme
